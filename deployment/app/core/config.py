...
def load_config() -> ServiceConfig:
    model_path = os.path.expanduser(os.environ.get("NANOVLLM_MODEL_PATH", "~/voicingtts"))
...
def materialize_lora_config(config: RuntimeLoRAConfig, architecture: str) -> MaterializedRuntimeLoRAConfig:
    ...
    if architecture == "voicingtts":
        default_proj_targets = VOICINGTTS_PROJ_LORA_TARGETS
    elif architecture == "voicingtts2":
        default_proj_targets = VOICINGTTS2_PROJ_LORA_TARGETS
    else:
