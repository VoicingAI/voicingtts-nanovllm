...
class VoicingTTS:
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        if arch == "voicingtts":
            from voicingtts_nanovllm.models.voicingtts.server import (
                AsyncVoicingTTSServerPool,
                SyncVoicingTTSServerPool,
            )

            async_server_pool_cls = AsyncVoicingTTSServerPool
            sync_server_pool_cls = SyncVoicingTTSServerPool
        elif arch == "voicingtts2":
            from voicingtts_nanovllm.models.voicingtts2.server import (
                AsyncVoicingTTS2ServerPool,
                SyncVoicingTTS2ServerPool,
            )

            async_server_pool_cls = AsyncVoicingTTS2ServerPool
            sync_server_pool_cls = SyncVoicingTTS2ServerPool
        else:
