...
def load_voicingtts2_lora_checkpoint(path: str, *, tp_size: int = 1) -> LoRAModelPayload | list[LoRAModelPayload]:
...
def _parse_weight_key(key: str) -> tuple[str, str, str | int, str] | None:
    ...
    packed_mapping = VoicingTTS2Model.packed_modules_mapping.get(leaf)
