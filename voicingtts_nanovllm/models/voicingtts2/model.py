...
from voicingtts_nanovllm.layers.linear import MergedColumnParallelLinear, QKVParallelLinear, RowParallelLinear
...
class VoicingTTS2Model(nn.Module):
    ...
    def __init__(self, config: VoicingTTS2Config, inference_timesteps: int, lora_config: Optional[LoRAConfig] = None):
        super().__init__()
        self.config = config
        ...
        self.feat_encoder = VoicingTTS2LocEnc(encoder_config, input_dim=config.feat_dim)
        ...
        self.feat_decoder = UnifiedCFM(
            ...
            estimator=VoicingTTS2LocDiT(decoder_config, in_channels=config.feat_dim, lora_config=lora_config),
