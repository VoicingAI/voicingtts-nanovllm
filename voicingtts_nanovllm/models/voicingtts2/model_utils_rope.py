"""RoPE and positional-embedding helpers for VoicingTTS2.

These helpers are pure CPU math and are kept separate from the broader
VoicingTTS2 utility module so the config and CFG helpers stay under the file-size
ceiling.
"""
...
def build_rope_cos_sin_cache(
    ...
    """Build the cos/sin embedding caches used by BackboneLongRoPE."""
