"""Pure CPU-testable utilities extracted from voicingtts2/model.py.

All functions here are free of CUDA / flash-attn / Triton dependencies and
can be exercised in a standard CPU pytest session.
"""

from voicingtts_nanovllm.models.voicingtts2 import model_utils_cfm as _cfm
from voicingtts_nanovllm.models.voicingtts2 import model_utils_rope as _rope
...
# ---------------------------------------------------------------------------
# VoicingTTS2Model config-derivation helpers
# ---------------------------------------------------------------------------
...
def derive_encoder_config_fields(
    ...
    """Return the fields that VoicingTTS2Model patches onto a deep-copy of lm_config
    to produce the encoder_config passed to VoicingTTS2LocEnc.
...
def derive_decoder_config_fields(
    ...
    """Return the fields that VoicingTTS2Model patches onto a deep-copy of lm_config
    to produce the decoder_config passed to VoicingTTS2LocDiT.
