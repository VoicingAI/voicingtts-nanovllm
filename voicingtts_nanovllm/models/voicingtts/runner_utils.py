"""voicingtts_nanovllm.models.voicingtts.runner_utils

Pure CPU helpers extracted from VoicingTTSRunner so they can be unit-tested without
...
def collect_seeded_rows(
    ...
    *,
    ...
    Args:
        seqs: Sequence of :class:`~voicingtts_nanovllm.engine.model_runner.RunnerTask`
...
def assemble_batch_inputs(
    ...
    *,
    ...
    Args:
        seqs: List of runner tasks with VoicingTTSPayload as ``custom_payload``.
        payload_attr: Attribute name on each task holding the payload.
