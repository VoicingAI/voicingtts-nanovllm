...
class _VendoredTritonPunicaBackend:
    ...
    def _ops(self):
        shrink_module = import_module("voicingtts_nanovllm.lora_ops.triton_ops.lora_shrink_op")
        expand_module = import_module("voicingtts_nanovllm.lora_ops.triton_ops.lora_expand_op")
    ...
    def prime_slice_caches(
        ...
        *,
        ...
        if not lora_a_slices or not lora_b_slices:
            return
        utils_module = import_module("voicingtts_nanovllm.lora_ops.triton_ops.utils")
