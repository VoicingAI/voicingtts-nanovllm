"""voicingtts_nanovllm.engine.block_manager
...
--------------------------------
:class:`~voicingtts_nanovllm.engine.scheduler.Scheduler` is the only policy layer.
...
------------------------
VoicingTTS requests encode both text and audio context. In
``voicingtts_nanovllm/models/voicingtts/engine.py``, the sequence's ``token_ids``
