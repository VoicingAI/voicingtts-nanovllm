...
- `voicingtts_nanovllm/models/voicingtts/server.py:108` executes `wav_tensor.cuda()` in the service layer.
- `voicingtts_nanovllm/engine/model_runner.py:292` to `voicingtts_nanovllm/engine/model_runner.py:360` build the attention context and perform Host-to-Device transfers inside the runner.
- `voicingtts_nanovllm/models/voicingtts/runner.py:125` to `voicingtts_nanovllm/models/voicingtts/runner.py:132` asynchronously move the payload from CPU to GPU inside the runner.
- `voicingtts_nanovllm/models/voicingtts/runner.py:151` to `voicingtts_nanovllm/models/voicingtts/runner.py:157`, and `voicingtts_nanovllm/models/voicingtts/runner.py:170`, move results back from GPU to CPU inside the runner.
...
Location: `BaseModelRunner` / `VoicingTTSRunner`
...
- `voicingtts_nanovllm/models/voicingtts/server.py:108` to `voicingtts_nanovllm/models/voicingtts/server.py:117`
