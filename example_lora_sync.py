...
from voicingtts_nanovllm.models.voicingtts2.server import SyncVoicingTTS2ServerPool

MODEL_NAME = "/models/ttsv2"
LORA_NAME = "demo"
...
VOICINGTTS2_PROJ_LORA_TARGETS = ["enc_to_lm_proj", "lm_to_dit_proj", "res_to_dit_proj", "fusion_concat_proj"]


def main():
    print("Loading...")
    server: SyncVoicingTTS2ServerPool = VoicingTTS.from_pretrained(
        MODEL_NAME,
        ...
        lora_config=LoRAConfig(
            ...
            target_proj_modules=VOICINGTTS2_PROJ_LORA_TARGETS,
        ),
    )
    print("Ready")
