...
def test_vendored_backend_groups_shrink_and_expand_independently():
    from voicingtts_nanovllm.lora import LoRAMetadata, _VendoredTritonPunicaBackend
...
def test_lora_runtime_slot_reuse_clears_modules_absent_from_new_adapter():
    ...
    from voicingtts_nanovllm.lora import set_backend_for_testing
    from voicingtts_nanovllm.utils.context import LoRAContext, reset_lora_context, set_lora_context
...
def test_vendored_lora_plan_cache_uses_stable_shape_key_for_temporary_views():
    from voicingtts_nanovllm.lora import _VendoredTritonPunicaBackend
