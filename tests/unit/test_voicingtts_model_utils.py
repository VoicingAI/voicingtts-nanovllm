"""Unit tests for voicingtts_nanovllm/models/voicingtts/model_utils.py.
...
def test_rotate_half_shape_preserved():
    from voicingtts_nanovllm.models.voicingtts.model_utils import rotate_half
...
def test_apply_rotary_pos_emb_output_shapes():
    from voicingtts_nanovllm.models.voicingtts.model_utils import apply_rotary_pos_emb
...
def test_apply_rotary_pos_emb_numerical_sanity():
    ...
    from voicingtts_nanovllm.models.voicingtts.model_utils import apply_rotary_pos_emb, rotate_half
...
def test_apply_rotary_emb_tokens_shape():
    from voicingtts_nanovllm.models.voicingtts.model_utils import apply_rotary_emb_tokens
...
def test_compute_longrope_scaling_factor_no_extension():
    ...
    from voicingtts_nanovllm.models.voicingtts.model_utils import compute_longrope_scaling_factor
...
def test_compute_longrope_freqs_shape():
    from voicingtts_nanovllm.models.voicingtts.model_utils import compute_longrope_freqs
...
def test_optimized_scale_parallel_vectors():
    ...
    from voicingtts_nanovllm.models.voicingtts.model_utils import optimized_scale
...
def test_sway_sampling_schedule_shape():
    from voicingtts_nanovllm.models.voicingtts.model_utils import sway_sampling_schedule
...
def test_sinusoidal_pos_emb_shape():
    from voicingtts_nanovllm.models.voicingtts.model_utils import sinusoidal_pos_emb
...
def test_combine_feature_and_text_embeddings_selects_by_mask():
    from voicingtts_nanovllm.models.voicingtts.model_utils_shapes import combine_feature_and_text_embeddings
...
def test_select_prefill_hidden_selects_final_token_from_each_sequence():
    from voicingtts_nanovllm.models.voicingtts.model_utils_shapes import select_prefill_hidden
...
def test_prepare_local_encoder_inputs_prepends_special_token_per_batch_item():
    from voicingtts_nanovllm.models.voicingtts.model_utils_shapes import prepare_local_encoder_inputs
...
def test_quantize_scalar_latents_rounds_to_configured_scale():
    from voicingtts_nanovllm.models.voicingtts.model_utils_shapes import quantize_scalar_latents
...
def test_prepare_dit_decoder_input_prepends_conditioned_prefix():
    from voicingtts_nanovllm.models.voicingtts.model_utils_shapes import prepare_dit_decoder_input
...
def test_apply_classifier_free_guidance_uses_optimal_negative_scale():
    from voicingtts_nanovllm.models.voicingtts.model_utils_shapes import apply_classifier_free_guidance
...
def test_cpu_module_wrappers_preserve_expected_shapes():
    from voicingtts_nanovllm.models.voicingtts.model import ScalarQuantizationLayer, SinusoidalPosEmb, TimestepEmbedding
...
def test_local_encoder_and_cfm_forward_bookkeeping_runs_on_cpu():
    ...
    from voicingtts_nanovllm.models.voicingtts.model import UnifiedCFM, VoicingTTSLocEnc

    class EncoderIdentity(nn.Module):
        def forward(self, inputs, positions):
            return inputs

    encoder = VoicingTTSLocEnc.__new__(VoicingTTSLocEnc)
...
def test_voicingtts_model_forward_uses_cpu_bookkeeping_with_stubbed_submodules(monkeypatch):
    ...
    model = model_module.VoicingTTSModel.__new__(model_module.VoicingTTSModel)
    nn.Module.__init__(model)
