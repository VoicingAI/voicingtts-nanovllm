...
def test_lora_manager_lifecycle_and_draining():
    from voicingtts_nanovllm.engine.lora_manager import LoRALifecycleState, LoRAManager
...
def test_lora_manager_tracks_admission_capacity_without_runtime_payloads():
    from voicingtts_nanovllm.engine.lora_manager import LoRAManager
    from voicingtts_nanovllm.lora import set_backend_for_testing
...
def test_lora_manager_validates_max_lora_rank_on_register():
    from voicingtts_nanovllm.engine.lora_manager import LoRAManager, LoRAModelPayload, LoRAModulePayload
    from voicingtts_nanovllm.lora import set_backend_for_testing
...
def test_lora_context_can_defer_device_metadata_for_graph_replay(monkeypatch):
    import voicingtts_nanovllm.engine.lora_manager as lora_manager
