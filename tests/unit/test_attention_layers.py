"""Tests for voicingtts_nanovllm.layers.attention – CPU-reachable non-kernel logic.
...
class TestStoreKvcacheAssertions:
    ...
    def test_mismatched_slot_mapping_length_raises(self):
        ...
        from voicingtts_nanovllm.layers.attention import store_kvcache
...
def test_causal_attention_prefill_and_decode_execute_real_cuda_kernels():
    ...
    from voicingtts_nanovllm.layers.attention import Attention
    from voicingtts_nanovllm.utils.context import reset_context, set_context
