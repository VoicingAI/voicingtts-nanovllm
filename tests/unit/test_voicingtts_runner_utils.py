...
class TestCollectSeededRows:
    def test_empty_list(self):
        from voicingtts_nanovllm.models.voicingtts.runner_utils import collect_seeded_rows
...
class TestComputePadLengths:
    def test_all_none(self):
        from voicingtts_nanovllm.models.voicingtts.runner_utils import compute_pad_lengths
...
class TestAssembleBatchInputs:
    def test_single_seq_shapes(self):
        from voicingtts_nanovllm.models.voicingtts.runner_utils import assemble_batch_inputs
...
class TestSliceWaveforms:
    def test_no_padding(self):
        from voicingtts_nanovllm.models.voicingtts.runner_utils import slice_waveforms
...
class TestAssembleRunOutputs:
    def test_output_values_are_matched_by_sequence(self):
        from voicingtts_nanovllm.models.voicingtts.runner_utils import assemble_run_outputs
