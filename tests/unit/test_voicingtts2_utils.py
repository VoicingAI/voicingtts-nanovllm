"""Tests for voicingtts_nanovllm.models.voicingtts2.utils.

All tests run on CPU and do not require GPU kernels or model weights.

The voicingtts2 package __init__.py triggers a heavy import cascade (engine ->
...
``from voicingtts_nanovllm.models.voicingtts2.utils import ...``.
"""
...
# ---------------------------------------------------------------------------
_UTILS_PATH = Path(__file__).parents[2] / "voicingtts_nanovllm" / "models" / "voicingtts2" / "utils.py"
_CANONICAL_NAME = "voicingtts_nanovllm.models.voicingtts2.utils"
...
from voicingtts_nanovllm.models.voicingtts2.utils import mask_multichar_chinese_tokens  # noqa: E402
