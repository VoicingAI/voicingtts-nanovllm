...
from voicingtts_nanovllm.utils.context import LoRAContext
...
class _FakePunicaBackend:
    def availability(self):
        from voicingtts_nanovllm.lora import LoRAAvailability
...
def _install_fake_punica_backend():
    from voicingtts_nanovllm.lora import set_backend_for_testing
...
def _reset_lora_context():
    from voicingtts_nanovllm.utils.context import reset_lora_context
...
def test_lora_linear_cuda_modes_and_rank_alpha():
    from voicingtts_nanovllm.layers.lora import LoRALinear
    from voicingtts_nanovllm.utils.context import set_lora_context
...
def test_lora_linear_cuda_graph_replay():
    from voicingtts_nanovllm.layers.lora import LoRALinear
    from voicingtts_nanovllm.lora import _VendoredTritonPunicaBackend, set_backend_for_testing
    from voicingtts_nanovllm.utils.context import set_lora_context
...
def test_runner_lora_cuda_graph_replay_supports_active_lora_count_changes():
    ...
    from voicingtts_nanovllm.engine.model_runner import BaseModelRunner
    from voicingtts_nanovllm.lora import _VendoredTritonPunicaBackend, set_backend_for_testing
    from voicingtts_nanovllm.utils.context import reset_all_contexts, set_context, set_lora_context
...
def test_lora_linear_triton_lora_b_pointer_cache_stays_bounded():
    from voicingtts_nanovllm.layers.lora import LoRALinear
    from voicingtts_nanovllm.lora import _VendoredTritonPunicaBackend, set_backend_for_testing
    from voicingtts_nanovllm.lora_ops.triton_ops import utils as lora_utils
    from voicingtts_nanovllm.utils.context import set_lora_context
...
def test_lora_merged_column_set_slot_applies_scaling_once():
    from voicingtts_nanovllm.layers.lora import LoRAMergedColumnParallelLinear
    from voicingtts_nanovllm.utils.context import set_lora_context
...
def _make_tp2_qkv_layer(rank: int):
    from voicingtts_nanovllm.layers.lora import LoRAQKVParallelLinear
    import voicingtts_nanovllm.layers.lora as lora_layers
...
def test_vendored_triton_backend_add_lora_cuda():
    from voicingtts_nanovllm.lora import LoRAMetadata, _VendoredTritonPunicaBackend, set_backend_for_testing
...
def test_vendored_triton_shrink_small_m_multi_lora_cuda():
    from voicingtts_nanovllm.lora_ops.triton_ops.lora_shrink_op import lora_shrink
