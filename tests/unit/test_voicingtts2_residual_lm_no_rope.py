...
def _make_config(residual_lm_no_rope: bool):
    ...
    return VoicingTTS2Config(
        ...
        encoder_config=VoicingTTS2EncoderConfig(hidden_dim=8, ffn_dim=16, num_heads=2, num_layers=1, kv_channels=4),
        dit_config=VoicingTTS2DitConfig(
            hidden_dim=8,
            ffn_dim=16,
            num_heads=2,
            num_layers=1,
...
def test_voicingtts2_model_disables_rope_only_for_residual_lm(monkeypatch):
