...
def test_cut_inputs_and_assign_outputs():
    from voicingtts_nanovllm.engine.model_runner import cut_inputs, assign_outputs
...
def test_select_lora_payload_for_rank():
    from voicingtts_nanovllm.engine.model_runner import select_lora_payload_for_rank
...
def test_tp2_register_lora_uses_rank_local_payload_and_runner_manager(monkeypatch):
    ...
    import voicingtts_nanovllm.engine.model_runner as model_runner
    from voicingtts_nanovllm.engine.lora_manager import LoRAModelPayload, LoRAModulePayload, LoRARuntime
    from voicingtts_nanovllm.layers.lora import LoRALinear
