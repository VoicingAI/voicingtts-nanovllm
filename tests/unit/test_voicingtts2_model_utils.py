"""Unit tests for voicingtts_nanovllm/models/voicingtts2/model_utils.py.
...
from voicingtts_nanovllm.models.voicingtts2 import model_utils
...
def test_scalar_quantization_layer_rounds_projected_latents():
    from voicingtts_nanovllm.models.voicingtts2.model import ScalarQuantizationLayer
...
def test_attention_and_mlp_select_lora_layers_on_cpu(monkeypatch):
    from voicingtts_nanovllm.models.voicingtts2 import model as voicingtts2_model

    monkeypatch.setattr(voicingtts2_model, "get_tp_world_size", lambda: 1)
    for layer_name in (
        "Attention",
        ...
        monkeypatch.setattr(voicingtts2_model, layer_name, _InertLayer)
