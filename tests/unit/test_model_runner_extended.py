"""Extended CPU-only tests for voicingtts_nanovllm.engine.model_runner.
...
def _reset_lora_backend():
    ...
    """
    from voicingtts_nanovllm.lora import LoRAAvailability, set_backend_for_testing
...
def test_env_int_returns_none_for_absent_var():
    from voicingtts_nanovllm.engine.model_runner import _env_int
...
def test_runner_task_with_adapter_id():
    from voicingtts_nanovllm.engine.model_runner import RunnerTask
...
def test_clear_lora_slot_modules_with_module_names_filter():
    ...
    import voicingtts_nanovllm.engine.model_runner as model_runner
    from voicingtts_nanovllm.layers.lora import LoRALinear
...
def test_expand_dit_lora_slots_uses_cfg_branch_major_order():
    from voicingtts_nanovllm.engine.model_runner import expand_dit_lora_slots
...
def test_build_lora_contexts_no_adapters_returns_empty_lm_and_no_lora_flags():
    import voicingtts_nanovllm.engine.model_runner as model_runner
    from voicingtts_nanovllm.engine.lora_manager import LoRARuntime
    from voicingtts_nanovllm.utils.context import LM_LORA_DOMAIN, PROJ_LORA_DOMAIN, DIT_LORA_DOMAIN
...
def test_unregister_lora_calls_lora_runtime():
    import voicingtts_nanovllm.engine.model_runner as model_runner
    from voicingtts_nanovllm.engine.lora_manager import LoRARuntime, LoRAModelPayload, LoRAModulePayload
...
def test_lora_lifecycle_calls_delegated_to_runtime():
    import voicingtts_nanovllm.engine.model_runner as model_runner
    from voicingtts_nanovllm.engine.lora_manager import LoRARuntime, LoRAModelPayload
...
def test_validate_lora_payload_rejects_zero_rank():
    import torch.nn as nn
    import voicingtts_nanovllm.engine.model_runner as model_runner
    from voicingtts_nanovllm.engine.lora_manager import LoRAModelPayload
...
def test_validate_lora_payload_rejects_non_lora_module():
    ...
    import torch.nn as nn
    import voicingtts_nanovllm.engine.model_runner as model_runner
    from voicingtts_nanovllm.engine.lora_manager import LoRAModelPayload, LoRAModulePayload
...
def test_register_lora_mismatch_raises_runtime_error():
    import voicingtts_nanovllm.engine.model_runner as model_runner
    from voicingtts_nanovllm.engine.lora_manager import LoRAModelPayload, LoRARuntime
...
def test_prepare_prefill_context_slot_mapping_correctness(monkeypatch):
    ...
    runner = object.__new__(model_runner.BaseModelRunner)
    runner.block_size = 4
    runner.lora_runtime = __import__("voicingtts_nanovllm.engine.lora_manager", fromlist=["LoRARuntime"]).LoRARuntime(
...
def test_build_lora_contexts_with_active_adapter():
    ...
    def fake_build_batch_plan(adapter_ids, token_counts, load_lora):
        ...
        from voicingtts_nanovllm.engine.lora_manager import LoRABatchPlan
...
def test_copy_lora_domain_uses_one_host_staged_metadata_copy():
    import voicingtts_nanovllm.engine.model_runner as model_runner
    from voicingtts_nanovllm.utils.context import LM_LORA_DOMAIN, LoRAContext
...
def test_copy_lora_domain_no_lora_flag_resets_to_sentinel():
    import voicingtts_nanovllm.engine.model_runner as model_runner
    from voicingtts_nanovllm.utils.context import LoRAContext, LM_LORA_DOMAIN
...
def test_prefill_diffusion_graph_pads_to_bucket_and_returns_real_batch(monkeypatch):
    import voicingtts_nanovllm.engine.model_runner as model_runner
    from voicingtts_nanovllm.utils.context import DIT_LORA_DOMAIN, LoRAContext
...
def test_prefill_diffusion_eager_fallback_removes_graph_bucket_lora_padding():
    ...
    from voicingtts_nanovllm.engine.model_runner import BaseModelRunner, expand_dit_lora_slots
    from voicingtts_nanovllm.utils.context import (
        DIT_LORA_DOMAIN,
