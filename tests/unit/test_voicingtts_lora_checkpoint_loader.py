...
def test_load_voicingtts_lora_checkpoint_builds_payload_and_tp_shards(tmp_path):
    ...
    payloads = load_voicingtts_lora_checkpoint(str(checkpoint_dir), tp_size=2)
...
def test_load_voicingtts_lora_checkpoint_requires_lora_config_object(tmp_path):
    from voicingtts_nanovllm.models.voicingtts.lora_loader import load_voicingtts_lora_checkpoint
    ...
    with pytest.raises(ValueError, match="lora_config"):
        load_voicingtts_lora_checkpoint(str(checkpoint_dir))


def test_load_voicingtts_lora_checkpoint_rejects_weight_suffix_keys(tmp_path):
    from voicingtts_nanovllm.models.voicingtts.lora_loader import load_voicingtts_lora_checkpoint
...
def test_load_voicingtts_lora_checkpoint_rejects_mixed_weight_suffix_keys(tmp_path):
    from voicingtts_nanovllm.models.voicingtts.lora_loader import load_voicingtts_lora_checkpoint
