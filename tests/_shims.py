...
set up shims before any voicingtts_nanovllm code is imported.
"""
...
def install_gpu_shims() -> None:
    ...
    # -------------------------------------------------------------------------
    # flash_attn shim (needed because voicingtts_nanovllm/__init__.py imports llm).
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # transformers shim (needed by voicingtts2 engine and utils imports).
    #
